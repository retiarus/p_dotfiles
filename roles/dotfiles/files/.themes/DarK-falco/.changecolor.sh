...
#recolor the theme
printf "\n\nChanging color\n\n"
find "$_basedir" -mindepth 2 -type f -not -path "*/.git/*" -not -path "*/backup/*" -not -path "*/gtksourceview/*" -not -path "*/metacity-1/*" -not -path "*/xfwm4/*" -not -path "*/unity/*" -not -path "*/icewm/*" -exec sed -i 's/#7eae55/'$newcolor'/g' {} \;
find "$_basedir" -mindepth 2 -type f -not -path "*/.git/*" -not -path "*/backup/*" -not -path "*/gtksourceview/*" -not -path "*/metacity-1/*" -not -path "*/xfwm4/*" -not -path "*/unity/*" -not -path "*/icewm/*" -exec sed -i 's/#7EAE55/'$newcolor'/g' {} \;
...
find "$_basedir" -mindepth 2 -type f -not -path "*/.git/*" -not -path "*/backup/*" -not -path "*/gtksourceview/*" -not -path "*/metacity-1/*" -not -path "*/xfwm4/*" -not -path "*/unity/*" -not -path "*/icewm/*" -exec sed -i 's/#F2F1F1/'$newcolor2'/g' {} \;
sed -i 's/#7EAE55/'$newcolor'/g' "$_basedir"/Extras/App_themes/icewm/DarK/menusel.xpm
sed -i 's/#7EAE55/'$newcolor'/g' "$_basedir"/Extras/App_themes/icewm/DarK/taskbar/taskbuttonactive.xpm
sed -i 's/#7EAE55/'$newcolor'/g' "$_basedir"/Extras/App_themes/icewm/DarK/default.theme
