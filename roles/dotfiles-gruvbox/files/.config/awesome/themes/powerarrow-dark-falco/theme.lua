...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerarrow-dark-falco"
...
theme.tasklist_bg_focus                         = "#d65d0e"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox_top = awful.wibar({ position = "top", screen = s, height = dpi(18), bg = theme.bg_normal, fg = theme.fg_normal })
    s.mywibox_bottom = awful.wibar({ position = "bottom", screen = s, height = dpi(18), bg = theme.bg_normal, fg = theme.fg_normal })
