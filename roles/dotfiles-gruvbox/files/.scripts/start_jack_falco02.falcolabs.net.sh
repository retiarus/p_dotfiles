...
pw-jack zita-n2j --chan "1, 2" 192.168.5.2 9999 --jname n2j-9999 &
...
pw-jack zita-j2n --jname j2n-falco06 --chan 2 192.168.5.6 9999 &
...
pw-jack carla ~/.config/carla-mixer/falco02.carxp &
