...
zita-j2n --chan 2 --ipv4 falco05 9999 --chan 2 --jname zita-j2n-falco05 &
zita-j2n --chan 2 --ipv4 sound01 9999 --chan 2 --jname zita-j2n-sound01 &
zita-j2n --chan 2 --ipv4 falco02 9999 --chan 2 --jname zita-j2n-falco02 &

sleep 2

carla ~/.config/carla-mixer/falco06.carxp &
